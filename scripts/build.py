...
# El orden importa: senado.py escribe docs/senado.json, del que dependen los
# dos scripts de comisiones para poner cara a los senadores.
TAREAS = [
    ...
    ("comisiones_congreso", "Comisiones del Congreso", "comisiones-congreso.html"),
    ("comisiones_senado", "Comisiones del Senado", "comisiones-senado.html"),
]
...
<header>
  ...
  <p>XV Legislatura &middot; Las dos Camaras al completo y todas sus comisiones, generado
     a partir de las fuentes oficiales de congreso.es y senado.es &middot;
     Actualizado el %%HOY%%</p>
</header>
<main>
%%TARJETAS%%
</main>
...
DESCRIPCIONES = {
    ...
    "comisiones-congreso.html": "Todas las comisiones y subcomisiones del Congreso, con su "
                                "composicion por cargo y buscador de personas.",
    "comisiones-senado.html": "Todas las comisiones del Senado, con su composicion por cargo "
                              "y buscador de personas.",
}
